...
import { Loading } from '@/nextjs-library/miscel/Loading';
import axios from 'axios';
import { Logo11 } from './Logo1';
...
export const Nav = () => {
    ...
    return (
        <div className='h-14 flex justify-between items-center px-4 py-2 fixed w-full top-0 z-30 bg-(--color1)' >
            <Logo />
